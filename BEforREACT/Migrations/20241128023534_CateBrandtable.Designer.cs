...
namespace BEforREACT.Migrations
{
    ...
    [Migration("20241128023534_CateBrandtable")]
    partial class CateBrandtable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BEforREACT.Data.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = new Guid("d1121cbd-d464-4843-870c-e7de3c0cbc85"),
                            CategoryName = "All Products",
                            CreatedAt = new DateTime(2024, 11, 28, 2, 35, 33, 66, DateTimeKind.Utc).AddTicks(329)
                        });
                });
